...
{
    // opdaterede scriptet til bare at have et constant offset, vi kan g�re s�dan,
    // at n�r man g�r backwards eller forwards bliver offsettet �ndret s� man kan se hvor man g�r
    // istedet for at f� player distance, s� f�r den bare player position p� pathen direkte.
    // s� kan vi bruge math lerp til at lerpe til spillerens position p� pathen
    // og s� kan vi bruge en coroutine til at lerp til den position
